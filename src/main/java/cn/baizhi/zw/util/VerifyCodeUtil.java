...
public class VerifyCodeUtil {
	...
	public static void main(String[] args) throws IOException {
		/*
		 * // File dir = new File("F:/verifies"); int w = 45, h = 80; String
		 * verifyCode = generateVerifyCode(5); File file = new File("D:\\",
		 * verifyCode + ".jpg"); outputImage(w*verifyCode.length(), h, file,
		 * verifyCode);
		 */
