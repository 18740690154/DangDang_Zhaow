  ...
  <div align=center style="font-size:25px">订单详细信息</div><hr/>
  	 <table bordercolor='#898E90' align='center' border='3px' cellpadding='5px' cellspacing="0px">
          ...
          <tr bgcolor="lightblue" align="center"> 
             ...
             <td colspan="2">订单状态：${order.order_state}</td>
          </tr>
          	<c:forEach items="${order.items}" var="item">
			<tr align='center'> 
				 <td>${item.book_name }</td>
				 <td style="width: 100px;"><img style="width:32px;height: 20px" src="${pageContext.request.contextPath}${item.book_src}"></td>
				 <td style="width: 180px;">单价：¥${item.price}</td>
				 <td style="width: 200px;">当当价：¥${item.dd_price}</td>
